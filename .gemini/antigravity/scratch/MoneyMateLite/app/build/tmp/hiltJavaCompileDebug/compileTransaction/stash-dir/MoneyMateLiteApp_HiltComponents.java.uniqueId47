...
import com.moneymate.lite.di.AppModule;
...
public final class MoneyMateLiteApp_HiltComponents {
  private MoneyMateLiteApp_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements MoneyMateLiteApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          LoanViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          LoanViewModel_HiltModules.BindsModule.class,
