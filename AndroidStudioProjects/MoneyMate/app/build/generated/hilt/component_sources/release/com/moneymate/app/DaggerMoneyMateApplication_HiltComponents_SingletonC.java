...
public final class DaggerMoneyMateApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends MoneyMateApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.templateViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 6);
      this.updateViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 7);
      this.uploadViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 8);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>builderWithExpectedSize(9).put(LazyClassKeyProvider.com_moneymate_app_ui_viewmodel_AuthViewModel, ((Provider) authViewModelProvider)).put(LazyClassKeyProvider.com_moneymate_app_ui_viewmodel_EditRequestViewModel, ((Provider) editRequestViewModelProvider)).put(LazyClassKeyProvider.com_moneymate_app_ui_viewmodel_LoanFileViewModel, ((Provider) loanFileViewModelProvider)).put(LazyClassKeyProvider.com_moneymate_app_ui_viewmodel_PaymentViewModel, ((Provider) paymentViewModelProvider)).put(LazyClassKeyProvider.com_moneymate_app_ui_viewmodel_PersonViewModel, ((Provider) personViewModelProvider)).put(LazyClassKeyProvider.com_moneymate_app_ui_viewmodel_SettingsViewModel, ((Provider) settingsViewModelProvider)).put(LazyClassKeyProvider.com_moneymate_app_ui_viewmodel_TemplateViewModel, ((Provider) templateViewModelProvider)).put(LazyClassKeyProvider.com_moneymate_app_ui_viewmodel_UpdateViewModel, ((Provider) updateViewModelProvider)).put(LazyClassKeyProvider.com_moneymate_app_ui_viewmodel_UploadViewModel, ((Provider) uploadViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new LoanFileViewModel(singletonCImpl.loanFileRepositoryProvider.get(), singletonCImpl.personRepositoryProvider.get(), singletonCImpl.provideDefaultPersonRepositoryProvider.get());

          case 3: // com.moneymate.app.ui.viewmodel.PaymentViewModel 
          return (T) new PaymentViewModel(singletonCImpl.paymentRepositoryProvider.get());

          case 4: // com.moneymate.app.ui.viewmodel.PersonViewModel 
          return (T) new PersonViewModel(singletonCImpl.personRepositoryProvider.get());

          case 5: // com.moneymate.app.ui.viewmodel.SettingsViewModel 
          return (T) new SettingsViewModel(singletonCImpl.appPreferencesProvider.get());

          case 6: // com.moneymate.app.ui.viewmodel.TemplateViewModel 
          return (T) new TemplateViewModel(singletonCImpl.provideDefaultPersonRepositoryProvider.get());

          case 7: // com.moneymate.app.ui.viewmodel.UpdateViewModel 
          ...
          case 8: // com.moneymate.app.ui.viewmodel.UploadViewModel 
          return (T) new UploadViewModel(singletonCImpl.loanFileRepositoryProvider.get(), singletonCImpl.personRepositoryProvider.get(), singletonCImpl.paymentRepositoryProvider.get(), singletonCImpl.provideDefaultPersonRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends MoneyMateApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.personRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<PersonRepository>(singletonCImpl, 4));
      this.provideDefaultPersonRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<DefaultPersonRepository>(singletonCImpl, 5));
      this.paymentRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<PaymentRepository>(singletonCImpl, 6));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.moneymate.app.utils.AppPreferences 
          ...
          case 1: // com.moneymate.app.data.repository.EditRequestRepository 
          ...
          case 4: // com.moneymate.app.data.repository.PersonRepository 
          return (T) new PersonRepository(singletonCImpl.personDao());

          case 5: // com.moneymate.app.data.repository.DefaultPersonRepository 
          return (T) AppModule_ProvideDefaultPersonRepositoryFactory.provideDefaultPersonRepository(singletonCImpl.defaultPersonDao());

          case 6: // com.moneymate.app.data.repository.PaymentRepository 
